...
export default function LandingPage() {
  ...
  <div id="nav" data-section="nav">
      ...
      navItems={[
        ...
        { name: "CONTACT HQ", id: "contact" },
      ]}
      brandName="BLACK OUT"
      button={{ text: "DEPLOY", href: "#loadout" }}
    />
  </div>
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        ...
        { src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3Bde77U5MUYBDTRPXFWZy0thE4g/confident-urban-customer-tactical-style--1774823236326-f2415bf3.png", alt: "Operator 2" },
        { src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3Bde77U5MUYBDTRPXFWZy0thE4g/portrait-of-an-urban-youth-wearing-tacti-1774823236124-18c80765.png", alt: "Operator 3" },
        { src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3Bde77U5MUYBDTRPXFWZy0thE4g/portrait-of-a-street-fashion-influencer--1774823236584-2634a016.png", alt: "Operator 4" },
        { src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3Bde77U5MUYBDTRPXFWZy0thE4g/portrait-of-a-confident-urban-customer-d-1774823236485-ed284467.png", alt: "Operator 5" },
      ]}
      avatarText="10k+ Operators Active"
      marqueeItems={[
        { type: "text-icon", text: "TACTICAL GRIT", icon: Shield },
        { type: "text-icon", text: "URBAN ELITE", icon: Zap },
        { type: "text-icon", text: "MAX DURABILITY", icon: Lock },
        { type: "text-icon", text: "STAY UNSEEN", icon: EyeOff },
        { type: "text-icon", text: "GLOBAL DROP", icon: Globe },
      ]}
    />
  </div>
  ...
  <div id="mission" data-section="mission">
      ...
      title="THE MISSION"
      metrics={[
        { icon: Shield, label: "DURABILITY", value: "MAX" },
        { icon: Zap, label: "PRECISION", value: "HIGH" },
        { icon: Star, label: "IDENTITY", value: "ELITE" },
      ]}
